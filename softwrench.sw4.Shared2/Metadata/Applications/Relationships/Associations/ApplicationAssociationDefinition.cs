...
namespace softwrench.sW4.Shared2.Metadata.Applications.Relationships.Associations {
    ...
    public class ApplicationAssociationDefinition :
        ...
        private string _returnAttribute;
        ...
        public ApplicationAssociationDefinition(string @from, LabelData labelData, string target, string qualifier, ApplicationAssociationSchemaDefinition applicationAssociationSchema,
            string showExpression, string toolTip, Boolean required, string defaultValue, bool hideDescription, string enableExpression = "true", ISet<ApplicationEvent> events = null, bool forceDistinctOptions = true, string returnAttribute = null)
            ...
            _returnAttribute = returnAttribute;
        ...
        public object Clone() {
            var cloned = new ApplicationAssociationDefinition(From, _labelData, Target, Qualifier, Schema, ShowExpression, ToolTip, IsRequired,
                DefaultValue, HideDescription, EnableExpression, _eventsSet, _forceDistinctOptions, _returnAttribute) {
