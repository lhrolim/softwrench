...
namespace softwrench.sW4.Shared2.Metadata.Applications.UI {
    ...
    public class FieldRenderer {
        private const string WrongRenderer = "renderer {0} not found. Possible options are radio,numericinput,datetime,textarea,screenshot,upload,default,image,treeview,label and color";
        ...
        public enum BaseRendererType {
            RADIO, NUMERICINPUT, DATETIME, SCREENSHOT, UPLOAD, TEXTAREA, DEFAULT, IMAGE, TREEVIEW, LABEL, CUSTOM,COLOR
        }
