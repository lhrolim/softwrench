...
namespace softwrench.sW4.Shared2.Metadata.Applications.UI {
    ...
    public class FieldRenderer {
        ...
        public enum BaseRendererType {
            RADIO, NUMERICINPUT, DATETIME, SCREENSHOT, UPLOAD, TEXTAREA, DEFAULT, IMAGE, TREEVIEW, LABEL, CUSTOM, COLOR, RICHTEXT, CHECKBOX, FIELDWITHBUTTONS, ICON, MULTIPLEUPLOAD, EMAIL, DNDUPLOAD, DATE, TIME, PASSWORD, STATUSCOLOR, IMAGEPREVIEW
        }
