namespace softwrench.sW4.Shared2.Metadata {
    public class ApplicationMetadataConstants
    {
        public const string List = "list";
        public const string Detail = "detail";
        
        //using @ to avoid collision with user defined metadata
        public const string SyncSchema = "@sync";

        public const string IsUserInteractionEnabledProperty = "mobile.userInteractionEnabled";
        ...
        public const string PreviewFeatured = "featured";
