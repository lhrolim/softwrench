...
namespace softwrench.sw4.firstsolardispatch.classes.com.cts.firstsolardispatch.services.email {
    public class DispatchArrivedEmailService : BaseDispatchStatusEmailService {
        ...
        public async Task SendEmail(DispatchTicket ticket) {
            ...
            var subject = "[#{0}] Technician arrived on {1}".Fmt(ticket.Id, site.FacilityName);
        ...
        protected override string GetTemplateFilePath() {
            return "//Content//Customers//firstsolardispatch//htmls//templates//dispatcharrived.html";
        }
    }
}
