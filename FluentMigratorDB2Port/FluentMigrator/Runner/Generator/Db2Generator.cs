...
namespace FluentMigratorDB2Port.FluentMigrator.Runner.Generator
{
    public class Db2Generator : GenericGenerator
    {
        ...
        public Db2Generator()
            : base(new Db2WindowsColumn(), new Db2Quoter(), new EmptyDescriptionGenerator())
        {
        }
        ...
        public override string Generate(global::FluentMigrator.Expressions.AlterDefaultConstraintExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.DeleteDefaultConstraintExpression expression)
        {
            return string.Format(
        ...
        public override string Generate(global::FluentMigrator.Expressions.RenameTableExpression expression)
        {
            return string.Format(
                "RENAME TABLE {0} TO {1}",
        ...
        public override string Generate(global::FluentMigrator.Expressions.DeleteColumnExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.CreateColumnExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.CreateForeignKeyExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.CreateConstraintExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.CreateIndexExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.CreateSchemaExpression expression)
        {
            return string.Format("CREATE SCHEMA {0}", Quoter.QuoteSchemaName(expression.SchemaName));
        }

        public override string Generate(global::FluentMigrator.Expressions.DeleteTableExpression expression)
        {
            return string.Format("DROP TABLE {0}", this.QuoteSchemaAndTable(expression.SchemaName, expression.TableName));
        }

        public override string Generate(global::FluentMigrator.Expressions.DeleteIndexExpression expression)
        {
            var indexWithSchema = string.IsNullOrEmpty(expression.Index.SchemaName) 
                ? Quoter.QuoteIndexName(expression.Index.Name)
                : Quoter.QuoteSchemaName(expression.Index.SchemaName) + "." + Quoter.QuoteIndexName(expression.Index.Name);
        ...
        public override string Generate(global::FluentMigrator.Expressions.DeleteSchemaExpression expression)
        {
            return string.Format("DROP SCHEMA {0} RESTRICT", Quoter.QuoteSchemaName(expression.SchemaName));
        }

        public override string Generate(global::FluentMigrator.Expressions.DeleteConstraintExpression expression)
        {
            var constraintName = string.IsNullOrEmpty(expression.Constraint.SchemaName)
                ? Quoter.QuoteConstraintName(expression.Constraint.ConstraintName)
                : Quoter.QuoteSchemaName(expression.Constraint.SchemaName) + "." + Quoter.QuoteConstraintName(expression.Constraint.ConstraintName);
        ...
        public override string Generate(global::FluentMigrator.Expressions.DeleteForeignKeyExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.DeleteDataExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.RenameColumnExpression expression)
        {
            return compatabilityMode.HandleCompatabilty("This feature not directly supported by most versions of DB2.");
        }

        public override string Generate(global::FluentMigrator.Expressions.InsertDataExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.UpdateDataExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.CreateTableExpression expression)
        {
        ...
        public override string Generate(global::FluentMigrator.Expressions.AlterColumnExpression expression)
        {
            try
            {
        ...
        public override string Generate(global::FluentMigrator.Expressions.AlterSchemaExpression expression)
        {
            return compatabilityMode.HandleCompatabilty("This feature not directly supported by most versions of DB2.");
        }
