(function (mobileServices) {
    ...
    mobileServices.factory('offlineCompositionService', ["$log", "swdbDAO", "offlineEntities", "attachmentDataSynchronizationService", function ($log, swdbDAO, offlineEntities, attachmentDataSynchronizationService) {
        ...
        const loadComposition = function (mainItem, displayable) {
