...
namespace softWrench.sW4.Data.Persistence.WS.Commons {
    public class AttachmentHandler {
        ...
        public Tuple<Byte[], string> DownloadViaParentWS(string id, string parentId, string parentApplication, string parentSchemaId) {
            ...
            var response = _dataSetProvider.LookupDataSet(parentApplication, applicationMetadata.Schema.SchemaId).Execute(applicationMetadata, new JObject(), parentId,  OperationConstants.CRUD_FIND_BY_ID,false);
