...
namespace softWrench.sW4.Data.Persistence.WS.Mea {
    class MeaWorkOrderCrudConnector : BaseWorkOrderCrudConnector {

        public MeaWorkOrderCrudConnector()
        {
            _attachmentHandler = new MeaAttachmentHandler();
        }
...
//                var realValue = (double)WsUtil.GetRealValue(integrationObject, "QUANTITY");
