...
namespace softWrench.sW4.Data.Persistence.Relational.Cache.Core {
    public class CustomJSONSerializer :ISerializer {
        ...
        public CustomJSONSerializer(JsonSerializerSettings settings = null) {
        ...
        public byte[] Serialize(object item) {
            ...
            var jsonString = JsonConvert.SerializeObject(item, Formatting.None, settings);
        ...
        public async Task<byte[]> SerializeAsync(object item) {
            var type = item.GetType();
            var jsonString = await Task.Factory.StartNew(() => JsonConvert.SerializeObject(item, Formatting.None, settings));
            return encoding.GetBytes(jsonString);
        }
