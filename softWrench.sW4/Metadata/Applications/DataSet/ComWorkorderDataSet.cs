...
namespace softWrench.sW4.Metadata.Applications.DataSet {
    class ComWorkorderDataSet: MaximoApplicationDataSet {

        public IEnumerable<IAssociationOption> GetWorkorderPriorityType(OptionFieldProviderParameters parameters) {
