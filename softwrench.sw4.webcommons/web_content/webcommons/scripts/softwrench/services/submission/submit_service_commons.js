...
(function (angular, jQuery) {
    ...
    angular.module('sw_layout').factory('submitServiceCommons', ["$injector", "schemaService", "fieldService", "checkpointService", function submitServiceCommons($injector, schemaService,fieldService, checkpointService) {
