(function (ng) {
    ...
    //taken from here:https://github.com/bennadel/DeferredWithUpdate.js/blob/master/examples/update-response.htm
        ...
        function ($q) {
            ...
            this.defer = function () {
                ...
                deferred.resolve = function () {
                    ...
                    // event - odd.
                    const upCallbackLength = updateCallbacks.length;

                    if (!isRejected && upCallbackLength !== 0) {

                        // Invoke all the update callbacks.
                        for (var i = 0, length = upCallbackLength; i < length; i++) {
