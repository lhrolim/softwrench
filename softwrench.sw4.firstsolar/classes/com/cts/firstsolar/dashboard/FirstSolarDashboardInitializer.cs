        ...
        public virtual void HandleEvent(ApplicationStartedEvent eventToDispatch) {
            ...
            var panels = new List<DashboardBasePanel> {
                new DashboardGridPanel
                {
                    ...
                    AppFields = "reportdate,#wpnum,description,plannerscheduler_.displayname,location_.facilityname,assetnum,schedstart,#buildcomplete,#colorcode",
                ...
                new DashboardGridPanel
                {
                    ...
                    Application = "workorder",
                    AppFields = "wonum,description,plannerscheduler_.displayname,location_.facilityname,assetnum,schedstart",
                    DefaultSortField = "schedstart",
