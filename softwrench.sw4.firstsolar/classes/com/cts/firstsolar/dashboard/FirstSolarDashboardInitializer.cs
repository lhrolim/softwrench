        ...
        public virtual void HandleEvent(ApplicationStartedEvent eventToDispatch) {
            ...
            var panelsCM = new List<DashboardBasePanel> {
                new DashboardGridPanel
                {
                    ...
                    AppFields = "#wpnum,description,planner,facilityname,asset_.description,reportdate,schedstart,daysleftcm,#buildcomplete,#colorcode",
                ...
                new DashboardGridPanel
                {
                    ...
                    Application = "workorder",
                    AppFields = "wonum,description,planner,facilityname,asset_.description,reportdate,schedstart",
