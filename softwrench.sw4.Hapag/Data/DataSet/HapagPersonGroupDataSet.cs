...
namespace softwrench.sw4.Hapag.Data.DataSet {
    ...
    class HapagPersonGroupDataSet : HapagBaseApplicationDataSet {
        public HapagPersonGroupDataSet(IHlagLocationManager locationManager, EntityRepository entityRepository, MaximoHibernateDAO maxDao) : base(locationManager, entityRepository, maxDao)
        {
        }
