        ...
        defaults: {
            ...
            buttonText: function (options, select) {
                if (options.length === 0) {
                    ...
                    var custombuttontext = select.attr('custombuttontext');
                    if (options.length > this.numberDisplayed) {
                        return options.length + ' ' + this.nSelectedText + ' <b class="caret"></b>';
                    } else if (select.find(':selected').length > 0 && custombuttontext != '') {
                        return custombuttontext + ' <b class="caret"></b>';
                    }
                    else {
                        var selected = '';
                        ...
                        var endsubstr = selected.length - 2;
                        if (selected.length >= 110) {
                            endsubstr = selected.length - 5;
                        }
                        return selected.substr(0, endsubstr) + ' <b class="caret"></b>';
                    }
                }
            },
            /**
